  ...
  const experiences = [
    {
      ...
      metrics: [" 500+ Campaigns", "40% Ops Efficiency Gain", "95% Client Satisfaction"],
      details:
      ...
      technologies: ["Google Apps Script ", "Google Sheets ","CRM Development ", "Team Management", "Business Strategy"],
    ...
    },
    {
      ...
      intro: "One of the founding members of a clothing brand startup in India, leading product development and business operations from the ground up.",
      metrics: ["Product Development", "Business Growth","Operational Strategy."],
      details: "Managed end-to-end operations — from website development to influencer partnerships and supply coordination. Oversaw team setup, handled collaborations and negotiations, and helped shape customer acquisition and retention strategies.",
      technologies: ["WordPress ", "Google Sheets", "Operations Management ", "Digital Strategy ", "Product Management"],
      logo: "/HOS.jpeg",
    },
  ]
              ...
              <div className="flip-card-inner">
                ...
                <Card className="flip-card-back bg-gradient-to-br from-primary/10 to-secondary/10 glassmorphism border-0 h-full">
                  <CardContent className="p-4 h-full flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-card-foreground mb-2\">{exp.company === "Navdrishti" ? "Skills Applied" : "Technologies Used"}:</h4>
