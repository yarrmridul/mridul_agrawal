      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-3 gap-10 ">
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            ...
            an eye for balance. I’m big on management, bigger on jugaad, and as
            a true Baniya, I’ve mastered the art of paisa bachao — whether it’s
            finding premium tools for free or negotiating deals that make
            everyone smile. And yes, I’ve convinced people to work with heart —
            sometimes even without pay, but never without respect.
          </p>
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed pt-5 mt-5">
            ...
            2018, when I was still in Class 10. What began as experiments soon
            grew into something real, and by 2020, I’d built Moodale — my
            real-time MBA in operations, marketing, and strategy. I didn’t know
            where it would lead then, and honestly, I still don’t — but that’s
            the fun part.
          </p>
          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            ...
            people who think differently, asking “why” one too many times, and
            building systems that make life (and work) smoother.
          </p>
        </div>
      </div>
    </main>
